          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="bg-white bg-opacity-50 backdrop-blur-sm rounded-xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-xl border border-white/20 w-full">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 lg:gap-12 text-center">
                ...
                <div className="p-4 md:p-6 lg:p-8 flex flex-col items-center justify-center h-40 md:h-48 lg:h-56">
                  <div className="flex items-center justify-center gap-4 md:gap-6 lg:gap-8 w-full">
                    <img src={appleLogo} alt="Apple" className="h-20 md:h-24 lg:h-28 xl:h-32 object-contain flex-shrink-0" />
                    <img src={appleNameLogo} alt="Apple" className="h-16 md:h-20 lg:h-24 xl:h-28 object-contain flex-shrink-0" />
                  </div>
                </div>
                
                {/* Everclear logo */}
                <div className="p-4 md:p-6 lg:p-8 flex flex-col items-center justify-center h-40 md:h-48 lg:h-56">
                  <img src={everclearLogo} alt="Everclear" className="h-20 md:h-24 lg:h-28 xl:h-32 w-auto object-contain" style={{ maxWidth: 'none' }} />
                </div>
                
                {/* Remaining stats */}
                {stats.slice(2).map((stat, index) => (
                  <div key={index + 2} className="p-4 md:p-6 lg:p-8 flex flex-col items-center justify-center h-40 md:h-48 lg:h-56">
