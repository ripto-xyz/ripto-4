...
export default function AboutSection() {
  ...
  const stats: Stat[] = aboutData?.stats || [
    ...
    { value: "9 Years", label: "Web3 Experience" }
  ];
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16 items-center">
              ...
              <div className="md:w-1/2 lg:w-3/5">
                ...
                <div className="space-y-4 md:space-y-6">
                  ...
                  <p className="text-base sm:text-lg md:text-xl text-white leading-relaxed">
                    Whether in DeFi, Middleware, or the Metaverse, a company's purpose must shine to create emotional bonds, making users feel part of a tribe beyond mere apps or infrastructure.
                  </p>
                  <p className="text-base sm:text-lg md:text-xl text-white leading-relaxed">
                    Drawing from first principles and not applying quick fixes, I craft brand identities and communities that actually resonate. These organically sustain growth that builds loyal fans who will tell everyone about your project—delivering a truly memorable and engaging experience.
                  </p>
