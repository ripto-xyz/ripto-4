  ...
  return (
    <div className={className}>
      ...
      <div className="logo-container spyro-logo-animated">
        ...
        <img className="letter letter-animated-2" src={I} alt="I" style={{ left: '210px', animationDelay: '1.0s' }} />
        ...
        <img className="letter-dot letter-animated-4" src={DOT} alt="." style={{ left: '290px', top: '16px', animationDelay: '1.4s' }} />
        <img className="letter letter-animated-2" src={E} alt="E" style={{ left: '305px', animationDelay: '1.5s' }} />
        <img className="letter letter-animated-1" src={T} alt="T" style={{ left: '325px', animationDelay: '1.6s' }} />
