              ...
              <div className="flex flex-col items-center md:items-start">
                ...
                <div className="flex space-x-4 mt-1">
                  ...
                  <a href="#" className="text-white hover:text-yellow-100 transition-colors">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 0C5.376 0 0 5.376 0 12s5.376 12 12 12 12-5.376 12-12S18.624 0 12 0zm5.568 8.16c-.18.516-1.392 6.12-1.896 8.16-.228.912-.456 1.308-.684 1.428-.684.228-1.368-.228-2.052-.684-.684-.456-4.788-3.192-2.052-3.192 1.14 0 3.648-3.42 3.648-3.42l-7.02 4.56c-.912.228-1.368.684-.228.912 1.824.456 3.648.912 4.788 1.14.456.684 3.192 2.052 4.56 2.736.684.456 1.824.228 2.052-.684.228-.912 1.368-7.752 1.368-7.752.228-1.368.228-2.508-.456-3.192-.456-.456-.912-.228-.912-.228l-12.54 4.788c-.684.228-.684.684-.228.912 1.824.456 3.876.912 5.928 1.368l3.876-2.508s-2.964 2.736-3.648 2.964c-1.824.456-3.42-1.824-1.824-2.052z"/>
                    </svg>
                  </a>
                </div>
              </div>
