      ...
      <div className="container-fluid mx-auto px-4 sm:px-6 z-10 relative py-8 sm:py-10 md:py-12">
        <div className="max-w-[1400px] mx-auto relative overflow-visible">
          <div className="relative overflow-visible">
            <div className="absolute top-32 right-[-20px] md:-top-20 md:right-[-60px] lg:-top-24 lg:right-[-80px] z-50 w-32 md:w-56 lg:w-72 elora-character" style={{ pointerEvents: 'none' }}>
              <img 
                src={eloraImage} 
                alt="Elora character" 
