...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className={`scroll-section relative ${isVisible ? 'animate-fadeIn' : ''}`}>
      ...
      <div className="absolute inset-0 bg-orange-500 bg-opacity-85 rounded-3xl mx-auto max-w-6xl my-12 shadow-2xl"></div>
      
      <div className="container mx-auto px-6 z-10 relative py-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 font-poppins text-white">Get in Touch</h2>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="grid grid-cols-1 gap-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 font-poppins text-white">Location</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 font-poppins text-white">Email</h3>
                <p className="text-white">
                  hello@ripto.eth<br />
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2 font-poppins text-white">Connect</h3>
