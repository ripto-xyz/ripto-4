...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className={`scroll-section relative py-12 ${isVisible ? 'animate-fadeIn' : ''}`}>
      <div className="max-w-3xl mx-auto relative">
        {/* Orange opaque background container */}
        <div className="absolute inset-0 bg-orange-500 bg-opacity-85 rounded-2xl shadow-xl"></div>
        
        <div className="relative z-10 px-8 py-10">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-2 font-poppins text-white">Get in Touch</h2>
          ...
          <div className="max-w-xl mx-auto">
            <div className="grid grid-cols-1 gap-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold mb-1 font-poppins text-white">Location</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold mb-1 font-poppins text-white">Email</h3>
                  <p className="text-white text-sm">
                    hello@ripto.eth<br />
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-bold mb-1 font-poppins text-white">Connect</h3>
