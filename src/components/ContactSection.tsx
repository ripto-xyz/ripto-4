      ...
      <div className="container-fluid mx-auto px-4 sm:px-6 z-10 relative py-8 sm:py-10 md:py-12">
        <div className="max-w-[1400px] mx-auto relative overflow-visible">
          <div className="relative overflow-visible">
            <div className="absolute top-24 right-[-40px] md:-top-20 md:right-[-60px] lg:-top-24 lg:right-[-80px] z-50 w-32 md:w-56 lg:w-72 elora-character" style={{ pointerEvents: 'none' }}>
              <img 
                src={eloraImage} 
                alt="Elora character" 
            ...
            <div className="bg-[#D81B60] bg-opacity-50 backdrop-blur-sm rounded-xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-xl border border-[#D81B60]/20 relative overflow-visible w-full mx-auto mt-4">
              <div className="text-center mb-6 sm:mb-8">
                ...
                <p className="text-base sm:text-lg md:text-xl text-white max-w-2xl mx-auto font-medium italic">
                  with yours truly...
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 xl:gap-32 mt-10 sm:mt-12 px-4 sm:px-8 md:px-12">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="flex items-center justify-center space-x-6 sm:space-x-8 mt-2">
                      ...
                      <a 
                        ...
                        className="text-white hover:text-yellow-100 transition-colors flex items-center justify-center"
                      ...
                      {/* Discord icon with tooltip - fixed size */}
                      <div className="relative group inline-block flex items-center justify-center">
                        <div 
                      ...
                      {/* Telegram icon - fixed size */}
                      <a 
                        href="https://t.me/riptothecrypto" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="text-white hover:text-yellow-100 transition-colors flex items-center justify-center"
