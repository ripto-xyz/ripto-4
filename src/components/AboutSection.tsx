        ...
        <div className="mt-8 md:mt-12 lg:mt-16">
          <div className="max-w-[1400px] mx-auto">
            <div className="bg-white bg-opacity-50 backdrop-blur-sm rounded-xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-xl border border-white/20 w-full">
              <div className="flex flex-wrap justify-center md:justify-between items-center gap-6 md:gap-4 lg:gap-6 text-center">
                {/* Apple logo with name */}
                <div className="flex items-center justify-center h-24 md:h-28 lg:h-32 flex-1 min-w-0">
                ...
                {/* Everclear logo */}
                <div className="flex items-center justify-center h-24 md:h-28 lg:h-32 overflow-visible flex-1 min-w-0">
                ...
                {stats.slice(2).map((stat, index) => (
                  <div key={index + 2} className="flex flex-col items-center justify-center h-24 md:h-28 lg:h-32 flex-1 min-w-0">
                    <div className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-1 md:mb-2">{stat.value}</div>
