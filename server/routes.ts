    ...
    return res.json([
      {
        ...
        description: "Role:\nLed the rebranding and repositioning from B2C to B2B focus, including token migration with new utility.\n\nActions:\nOrchestrated sequential rollout: communicated changes, user/project impacts, and old offering sunset; revisited tagline from first principles to emphasize support for other projects, proposing \"The Backbone of Bridging\" over vague alternatives like \"the first clearing layer.\"\n\nResults:\nSuccessfully transitioned brand identity, enhancing B2B appeal and token utility without major disruptions.\n\nKey Learnings:\nGrounding messaging in core value (supporting vs. competing) creates clearer, more impactful taglines; sequential communication minimizes user confusion during rebrands.",
      ...
      },
      {
        ...
        description: "Role:\nLed paid advertising campaign to promote new token staking feature, targeting native Web3 users familiar with similar protocols.\n\nActions:\nPartnered with Slise ad company to communicate project value, token mechanics, and incentives; used Dune Analytics to identify and segment users of comparable staking protocols; collaborated with graphic designer on visual concept drafts; conducted A/B testing in live campaign, including variants featuring a crosschain analytics dashboard I co-designed.\n\nResults:\nAchieved 0.45% CTR, driving a 3.8% increase in protocol staking.\n\nKey Learnings:\nData-driven audience segmentation via tools like Dune enhances targeting precision; real-time A/B testing optimizes ad performance and ROI in Web3 campaigns.",
